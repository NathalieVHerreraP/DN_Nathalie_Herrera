...
namespace WebApi.WindowsClient
{
    class Program
    {
        ...
        private static async Task<ZoneWeatherForecast> GetWeatherForecastAsync(Zone zone) 
        {
            ...
            HttpResponseMessage response = await client.PostAsync("https://localhost:44314/weatherforecast/byzone", new StringContent(jsonContent, Encoding.UTF8, "application/json"));
           ...
           // Console.WriteLine("My current Ip Address is: " + ip.Ip);
            ...
            //Console.WriteLine("Country is: " + info.Country);
            //Console.WriteLine("City is: " + info.City);
            //Console.WriteLine("TimeZone is: " + info.TimeZone);
